...
export function generatePackageJson(projectName, dbType, tables) {
    const dependencies = {
...
export function generateServerJs(port, dbType) {
...
export function generateDbConnection(dbType, tableNames) {
    if (dbType === 'mongodb') {
...
export function generateModelFile(table, dbType) {
    // --- MONGODB GENERATION ---
    if (dbType === 'mongodb') {
        let fieldsArr = [];
...
export function generateController(tableName, endpoints, dbType) {
...
export function generateRouteFile(controllerName, endpoints) {
...
export function generateExpressProject(zip, data) {
